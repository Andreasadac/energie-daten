...
def main():
    ...
    try:
        ...
        # Werte aus dem gerenderten Text extrahieren (DE/EN tolerant)
        ...
        if not m_ren or not m_fos:
            raise RuntimeError("Erneuerbar/Fossil nicht im gerenderten Text gefunden.")

        stand = extract_date(text)
        ...
        print("OK: energie.json aktualisiert:", "Erneuerbar", ren, "Fossil", fos, "Stand:", stand)

    except Exception as e:
        # letzter Stand bleibt: nicht überschreiben, nicht crashen
